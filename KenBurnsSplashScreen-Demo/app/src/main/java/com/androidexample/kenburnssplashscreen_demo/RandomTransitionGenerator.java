...
public class RandomTransitionGenerator implements com.androidexample.kenburnssplashscreen_demo.TransitionGenerator {

    /**
     * Default value for the transition duration in milliseconds.
     */
    public static final int DEFAULT_TRANSITION_DURATION = 8000;
